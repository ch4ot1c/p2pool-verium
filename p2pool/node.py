...
class Node(object):
    ...
    def start(self):
        ...
        def _(share):
            ...
            print
            print 'GOT BLOCK FROM PEER! Passing to veriumd! %s bitcoin: %s%064x' % (p2pool_data.format_hash(share.hash), self.net.PARENT.BLOCK_EXPLORER_URL_PREFIX, share.header_hash)
            print
